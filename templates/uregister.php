        ...
        <form action="home.php" method="POST">   
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="email" class="form-control form-rounded" id="email" placeholder="Enter your E-mail" name="email">
            </div>

             <div class="form-group">
                <label for="phone">Phone</label>
                <input type="phone" class="form-control form-rounded" id="phone" placeholder="Enter your Phone" name="phone">
            </div>

            <div class="form-group">
                <label for="Date">Date of Birth</label>
                <input type="date" class="form-control form-rounded" id="date" placeholder="Enter your Date of Birth" name="dob">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control form-rounded" id="password" placeholder="Password" name="confirmpassword">
            </div>
